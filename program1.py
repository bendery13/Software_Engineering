...
print("This text line is used to show conflict when two people try to make changes to the same line. I want to merge the program from the GUI and terminal!")
